        ...
        <Form submitHandler={onSubmit} defaultValues={defaultValues}>
          ...
          >
            ...
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              ...
              >
                <FormInput type='text' name='name.middleName' size='large' label='Middle Name' />
              </Col>
              <Col
                className='gutter-row'
                span={8}
          ...
          >
            ...
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              ...
              >
                <FormInput type='text' name='designation' size='large' label='Designation' />
              </Col>
              ...
              <Col span={12} style={{ margin: '10px 0' }}>
                <FormTextArea name='permanentAddress' label='Permanent address' rows={4} />
              </Col>
            </Row>
          </div>
